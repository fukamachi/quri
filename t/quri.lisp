...
(defun common-uri-equivalences-assertions ()
  ...
  (isnt (make-uri :scheme "http"  :host "b.hatena.ne.jp" :port 80 :path "/path")
        ...
        "Differ by scheme (distinct struct type).")
  (isnt (make-uri :scheme "foo" :host "b.hatena.ne.jp" :port 80 :path "/path")
        (make-uri :scheme "bar" :host "b.hatena.ne.jp" :port 80 :path "/path")
        "Differ by scheme (same struct type).")
